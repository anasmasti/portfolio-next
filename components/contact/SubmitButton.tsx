...
export default function SubmitButton({ status }: Readonly<SubmitButtonProps>) {
  ...
  if (isSuccess) {
    buttonColorClass =
      "border-green-400/60 bg-green-500/20 hover:border-green-300/80 hover:bg-green-500/30";
  } else if (isError) {
    buttonColorClass =
      "border-red-400/60 bg-red-500/20 hover:border-red-300/80 hover:bg-red-500/30";
  }
