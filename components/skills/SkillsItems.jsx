...
const skills = [
  {
    ...
    technologies: [
      ...
      { id: 4, technology: "Vue Js 3 (NuxtJs, Vuex/Pinia)" },
      { id: 5, technology: "Unit Testing (Jest, Jasmine)" },
      { id: 6, technology: "E2E Testing (Cypress)" },
      { id: 7, technology: "Css 3 (Sass, Tailwind css, Bootstrap)" },
      { id: 8, technology: "Html 5" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    technologies: [
      { id: 1, technology: "Figma" },
      { id: 2, technology: "Adobe XD" },
      { id: 3, technology: "Adobe Photoshop" },
    ],
  },
  {
    id: 11,
